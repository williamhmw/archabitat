    ...
    <>
      <header
        className={`fixed w-full bg-transparent ${
          isTop
            ? 'border-none'
            : 'dark:bg-violet-1000 border-b border-gray-200 dark:border-gray-800'
        } firefox:bg-opacity-100 dark:firefox:bg-opacity-100 top-0 z-30 flex items-center justify-between bg-white bg-opacity-30 backdrop-blur-lg dark:bg-opacity-30`}
      >
